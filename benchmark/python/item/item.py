...
def benchmark_item(benchmarkrun_list, iterations):
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/item/item/create", iterations), benchmark_item_create)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/item/item/create-batch", iterations), benchmark_item_create_batch)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/item/item/delete", iterations), benchmark_item_delete)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/item/item/delete-batch", iterations), benchmark_item_delete_batch)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/item/item/delete-batch-without-get", iterations), benchmark_item_delete_batch_without_get)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/item/item/get-status", iterations), benchmark_item_get_status)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/item/item/get-status-batch", iterations), benchmark_item_get_status_batch)
    # TODO: benchmark get (also missing in c benchmark)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/item/item/read", iterations), benchmark_item_read)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/item/item/read-batch", iterations), benchmark_item_read_batch)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/item/item/write", iterations), benchmark_item_write)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/item/item/write-batch", iterations), benchmark_item_write_batch)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/item/item/unordered-create-delete", iterations), benchmark_item_unordered_create_delete)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/item/item/unordered-create-delete-batch", iterations), benchmark_item_unordered_create_delete_batch)
